...
CADDY_IMAGE   ?= <your-registry>/caddy:3.11.0-2.11.1
WAFCTL_IMAGE  ?= <your-registry>/wafctl:2.12.0
...
Tag format: Caddy is `<project-version>-<caddy-version>` (e.g. `3.11.0-2.11.1`), wafctl is plain semver (e.g. `2.12.0`).
