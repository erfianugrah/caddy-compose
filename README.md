...
CADDY_IMAGE   ?= <your-registry>/caddy:2.6.3-2.11.1
WAFCTL_IMAGE  ?= <your-registry>/wafctl:1.6.3
...
Tag format: Caddy is `<project-version>-<caddy-version>` (e.g. `2.6.3-2.11.1`), wafctl is plain semver (e.g. `1.6.3`).
