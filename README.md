...
### Caddy image: `erfianugrah/caddy:1.23.0-2.10.2`
...
### WAF API image: `erfianugrah/waf-api:0.17.0`
...
| `CADDY_IMAGE` | `erfianugrah/caddy:1.23.0-2.10.2` | Caddy image tag |
| `WAF_API_IMAGE` | `erfianugrah/waf-api:0.17.0` | waf-api image tag |
