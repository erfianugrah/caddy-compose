...
CADDY_IMAGE   ?= <your-registry>/caddy:3.72.0-2.11.2
WAFCTL_IMAGE  ?= <your-registry>/wafctl:2.76.0
...
Tag format: Caddy is `<project-version>-<caddy-version>` (e.g. `3.72.0-2.11.2`), wafctl is plain semver (e.g. `2.76.0`).
