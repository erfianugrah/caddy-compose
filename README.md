...
CADDY_IMAGE   ?= <your-registry>/caddy:3.66.3-2.11.2
WAFCTL_IMAGE  ?= <your-registry>/wafctl:2.70.3
...
Tag format: Caddy is `<project-version>-<caddy-version>` (e.g. `3.66.3-2.11.2`), wafctl is plain semver (e.g. `2.70.3`).
