...
func TestGenerateConfigEndpoint(t *testing.T) {
	...
	mux.HandleFunc("POST /api/config/generate", handleGenerateConfig(cs, es, rs, nil, nil, nil, nil, DeployConfig{}))
...
func TestValidateNewConditionFields(t *testing.T) {
	...
	requestPhaseCases := []Condition{
		...
		{Field: "body", Operator: "eq", Value: "exact match"},
		{Field: "body", Operator: "begins_with", Value: "{\"type\":"},
		{Field: "body", Operator: "ends_with", Value: "</html>"},
		{Field: "body", Operator: "regex", Value: "password=.*"},
		{Field: "body_json", Operator: "eq", Value: ".user.role:admin"},
		{Field: "body_json", Operator: "contains", Value: ".name:test"},
		{Field: "body_json", Operator: "regex", Value: ".email:^[a-z]+@"},
		{Field: "body_json", Operator: "exists", Value: ".token:"},
		{Field: "body_form", Operator: "eq", Value: "action:delete"},
		{Field: "body_form", Operator: "contains", Value: "query:SELECT"},
		{Field: "body_form", Operator: "regex", Value: "cmd:^ls\\s"},
	...
	invalidCases := []Condition{
		...
		{Field: "body", Operator: "ip_match", Value: "1.2.3.4"},
		{Field: "body_json", Operator: "begins_with", Value: ".path:val"},
		{Field: "body_json", Operator: "neq", Value: ".path:val"},
		{Field: "body_form", Operator: "exists", Value: "field:"},
		{Field: "body_form", Operator: "neq", Value: "field:val"},
